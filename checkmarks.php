...
<body>
<center>
<div style="position:fixed;top:0px;height:100px;width:1545px;background-color:orange;font-size:25px;z-index:2;"><form method=post>
<br><b>
Student name:<input type=text name=nm>&nbsp;        Roll Number:<input type=text name=rn>     <input type=submit name=btn value="View Result"></b>
</form>
</div>
<img src=s2.png style="position:absolute;top:300px;height:500px;left:500px;width:550px;opacity:0.5;">
